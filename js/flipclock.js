...
(function ($) {
  ...
  FlipClock.DailyCounterFace = FlipClock.Face.extend({
    ...
    build: function (time) {
      ...
      if (this.showSeconds) {
        $(this.createDivider("Detik")).insertBefore(
      ...
      $(this.createDivider("Menit")).insertBefore(
        this.lists[this.lists.length - 4 + offset].$el
      );
      $(this.createDivider("Jam")).insertBefore(
        this.lists[this.lists.length - 6 + offset].$el
      );
      $(this.createDivider("Hari", true)).insertBefore(this.lists[0].$el);
